  ...
  return (
    <>
      <Box sx={{
        ...
        <Typography variant="body2" color="textSecondary" sx={{ textOverflow: 'ellipsis', overflow: 'hidden', textAlign: 'left' }}>
          You can add books to your reading list by searching for them in the search bar above.
        </Typography>
      </Box>
      <Box
        sx={{
          ...
          >
            ...
            <Box sx={{ flexGrow: 1, textAlign: 'left' }}>
              <Typography
                variant="subtitle1"
                color={theme.palette.info.main}
                noWrap sx={{ textOverflow: 'ellipsis', overflow: 'hidden', textAlign: 'left', fontWeight: 'bold' }}
              >
                {book.title}
              </Typography>
